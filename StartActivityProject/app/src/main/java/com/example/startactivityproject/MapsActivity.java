...
import com.example.startactivityproject.GetNearbyPlacesData;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void nearBy(){
        ...
        Toast.makeText(MapsActivity.this,"Showing nearby food...",Toast.LENGTH_LONG).show();
    ...
    private String getUrl(double lat,double lon){
        ...
        stringBuffer.append("&key=AIzaSyD1qNrBFoW5ZZzxDb6i0Mm5sr-cxYynbXI&radius=5000&types=restaurant&type=restaurant");
